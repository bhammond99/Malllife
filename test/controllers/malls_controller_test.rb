...
class MallsControllerTest < ActionController::TestCase
  ...
  test "should create mall" do
    assert_difference('Mall.count') do
      post :create, mall: { address: @mall.address, close: @mall.close, name: @mall.name, open: @mall.open }
    end
  ...
  test "should update mall" do
    patch :update, id: @mall, mall: { address: @mall.address, close: @mall.close, name: @mall.name, open: @mall.open }
    assert_redirected_to mall_path(assigns(:mall))
  end
